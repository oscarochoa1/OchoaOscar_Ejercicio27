...
void explicita(float xini, float xfini, float delta_t,float delta_t1, float delta_t2, float omega);
...
void explicita(float xini, float xfini, float delta_t, float delta_t1, float delta_t2, float omega){
    ...
    for (int i=xini;i<xfini;i++){
        ...
        yn1 = y - (delta_t1*omega*y);
        yn2 = y - (delta_t2*omega*y);
...
void implicita(float xini, float xfini, float delta_t,float delta_t1, float delta_t2, float omega){
    ...
    for (int i=xini;i<xfini;i++){
        ...
        yn1  = y/(1+delta_t1*omega);
        yn2  = y/(1+delta_t2*omega);
